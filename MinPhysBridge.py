...
get_line_intersection.argtypes = [c_float, c_float, c_float, c_float, c_float, c_float, c_float, c_float, c_float, c_float]
...
class FPoint(object):
    ...
    def getPoint(self):
        return FPoint_getPoint(self.obj)
    def getDistance(self, point):
        return FPoint_getDistance(self.obj, point)
    def move(self, vec):
        FPoint_move(self.obj, vec)
    def getX(self):
...
class MVec(object):
	...
	def vecCollsion(self, vec):
		return MVec_vecCollsion(self.obj, vec)
	def __del__(self):
		del_MVec(self.obj)
...
class Circ(object):
	...
	def __del__(self):
		del_Circ(self.obj)
	def getCirc(self):
		return Circ_getCirc(self.obj)
	def circHitCirc(self, circ):
		return circHitCirc(self.obj, circ)
	def getX(self):
...
class CircObj(object):
	def __init__(self, point, radius, XV, YV):
		self.obj = CircObj_new(point, radius, XV, YV)
	def __del__(self):
		del_CircObj(self.obj)
	def collisionCirc(self, circ):
		return CircObj_collisionCirc(self.obj, circ)
	def move(self):
...
class FLine(object):
	def __init__(self, p1, p2):
		self.obj = FLine_new(p1, p2)
	def __del__(self):
		del_FLine(self.obj)
	def getP1(self):
		return FLine_p1(self.obj)
	def getP2(self):
		return FLine_p2(self.obj)
	def setP1(self, point):
		set_FLine_p1(self.obj, point)
	def setP2(self, point):
		set_FLine_p2(self.obj, point)
	def findPerpPoint(self, p1, p2, p3):
		return FLine_findPerpPoint(self.obj, p1, p2, p3)
	def getDistance(self):
		return FPoint_getDistance(self.obj)
	def getMidPoint(self):
		return FLine_getMidPoint(self.obj)
	def hitLine(self, line):
		return FLine_hitLine(self.obj, line)
	def linehitCirc(self, perpPoint, circCenter, radius):
		return FLine_linehitCirc(self.obj, perpPoint, circCenter, radius)
class lineObj(object):
	def __init__(self, p1, p2, vec):
		self.obj = lineObj_new(p1, p2, vec)
	def __del__(self):
		del_lineObj(self.obj)
	def move(self):
		lineObj_move(self.obj)
	def hitLine(self, line):
		lineObj_hitLine(self.obj, line)
	def lineHitCirc(self, circ):
		lineObj_lineHitCirc(self.obj, circ)
	def setP1(self, p1):
		set_lineObj_p1(self.obj, p1)
	def setP2(self, p2):
		set_lineObj_p2(self.obj, p2)
	def setXV(self, xv):
...
class PPoint(object):
	...
	def getCenter(self):
		return getCenter_PPoint(self.obj)
	def setCenter(self, center):
		setCenter_PPoint(self.obj, center)
